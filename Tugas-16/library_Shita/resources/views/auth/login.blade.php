  ...
  <div class="container">
    <div class="card">
      <div class="side-info">
        ...
        <p>Login untuk melanjutkan perjalanan belajarmu bersama kami</p>
      </div>
      ...
      <div class="form-section">
        ...
        <form method="POST" action="{{ route('login') }}">
          ...
          <div class="text-center">
            <p style="color: white;">Belum punya akun? <a href="{{ route('register') }}">Daftar sekarang</a></p>
          </div>
