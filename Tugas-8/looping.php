...
<body>
    <h1>Berlatih Looping</h1>    <?php 
        ...
        */
        ...
        echo 'Ouput Pertama : ' .  " <br><br>";
        for($textPertama = 2; $textPertama <= 20 ; $textPertama += 2 ){
          echo $textPertama . " - I Love PHP" ."<br>";
        };
        echo "<br>";

        echo 'Ouput Kedua : ' .  " <br><br>";
        for($textPertama = 20; $textPertama >= 2 ; $textPertama -= 2 ){
          echo $textPertama . " - I Love PHP" ."<br>";
        };
